...
class OSS
{
    ...
    public $AccessKeyId = 'itWoGzGGLnygJB7t';                      // key
    public $AccessKeySecret = 'QNv1ySN0lR4YyEhv31YMalY3ZuJdsC';          // secret
    public $BucketName = 'weiyuyan';                // bucket
