...
-- ----------------------------
--  Table structure for `data_programme`
-- ----------------------------
DROP TABLE IF EXISTS `data_programme`;
CREATE TABLE `data_programme` (
  `id` int(11) NOT NULL AUTO_INCREMENT COMMENT '方案表',
  `programme` varchar(200) DEFAULT NULL COMMENT '方案',
  `status` tinyint(2) DEFAULT '1' COMMENT '状态 1可用 2禁用',
  PRIMARY KEY (`id`)
) ENGINE=InnoDB AUTO_INCREMENT=13 DEFAULT CHARSET=utf8;

-- ----------------------------
--  Records of `data_programme`
-- ----------------------------
BEGIN;
INSERT INTO `data_programme` VALUES ('9', '红领巾购买1件 &nbsp;数据线购买1件 &nbsp;玻璃纸购买8件 &nbsp;书架购买1件 &nbsp;签字笔购买1件 &nbsp;胶带购买2件 &nbsp;需花费64元', '1'), ('10', '红领巾购买1件 &nbsp;数据线购买1件 &nbsp;玻璃纸购买8件 &nbsp;书架购买1件 &nbsp;阿里云ECS（低配版）每月购买1件 &nbsp;签字笔购买1件 &nbsp;胶带购买1件 &nbsp;需花费122元', '1'), ('11', '红领巾购买1件 &nbsp;数据线购买1件 &nbsp;玻璃纸购买8件 &nbsp;书架购买1件 &nbsp;阿里云ECS（低配版）每月购买2件 &nbsp;签字笔购买1件 &nbsp;胶带购买1件 &nbsp;需花费182元', '1'), ('12', '《nodejs实战》购买1件 &nbsp;红领巾购买1件 &nbsp;玻璃纸购买8件 &nbsp;书架购买1件 &nbsp;阿里云ECS（低配版）每月购买1件 &nbsp;签字笔购买2件 &nbsp;胶带购买1件 &nbsp;需花费190元', '1');
COMMIT;
...
-- ----------------------------
BEGIN;
INSERT INTO `rel_plan` VALUES ('36', '4004f7e007c011e78c59ff2d2921a3ed', '19', '1', '/', '8', '8'), ('37', '80b37a9e07c211e79ec274e1932fb59d', '20', '1', '/', '9', '9'), ('38', 'a553bdda07c411e79fdd2fa8b74f9715', '19', '1', '/', '8', '10');
COMMIT;
